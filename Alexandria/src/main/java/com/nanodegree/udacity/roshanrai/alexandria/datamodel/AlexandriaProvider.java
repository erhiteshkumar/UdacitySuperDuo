...
public class AlexandriaProvider extends ContentProvider {
    ...
    private AlexandriaDbHelper alexandriaDbHelper;
    ...
    /**
     * On create of the contentprovider set the database helper object (connection)
     * @return boolean
     */
    @Override
    public boolean onCreate() {
        ...
        alexandriaDbHelper = new AlexandriaDbHelper(getContext());
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case BOOK:
                retCursor = alexandriaDbHelper.getReadableDatabase().query(
            ...
            case BOOK_FULLDETAIL:
                ...
                retCursor = bookFull.query(alexandriaDbHelper.getReadableDatabase(),
                        bfd_projection,
    ...
    /**
     * Get content type based on given uri
     * @param uri Uri
     * @return string
     */
    @Override
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        final SQLiteDatabase db = alexandriaDbHelper.getWritableDatabase();
        final int match = uriMatcher.match(uri);
        Uri returnUri;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        // notify change if rows were deleted
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // notify change if records were updated
        if (rowsUpdated != 0) {
            Context context = getContext();
            if (context != null) {
                context.getContentResolver().notifyChange(uri, null);
