...
import com.nanodegree.udacity.roshanrai.alexandria.datamodel.AlexandriaDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        SQLiteDatabase db = new AlexandriaDbHelper(this.mContext).getWritableDatabase();
    ...
    public void testInsertReadDb() {
        ...
        AlexandriaDbHelper alexandriaDbHelper = new AlexandriaDbHelper(mContext);
        SQLiteDatabase db = alexandriaDbHelper.getWritableDatabase();
    ...
    public static ContentValues getBookValues() {
        ...
        values.put(AlexandriaContract.BookEntry.SAVED, saved);
